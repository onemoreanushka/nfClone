...
function Navbar(){
    return(
        <>
            <div className="mt-4 mx-14 flex justify-between items-center">
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="netflix-logo h-24 w-62" viewBox="0 0 111 30">
                ...
                <Link to="/" className="text-3xl text-white ml-4 font-semibold">Home</Link>
            </div>
        </>
    )
}
